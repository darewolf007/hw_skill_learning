...
class DETRVAE(nn.Module):
    ...
    def __init__(self, backbones, transformer, encoder, args):
        ...
        Parameters:
            ...
            action_state_dim: robot state dimension of the environment
        ...
        self.latent_dim = args["latent_dim"] # final size of latent z
        ...
        if args["use_image"]:
            ...
            self.input_proj_robot_state = nn.Linear(args["joint_dim"], hidden_dim)
            self.input_proj_env_state = nn.Linear(args["env_dim"], hidden_dim)
        ...
        self.encoder_joint_proj = nn.Linear(self.joint_dim, hidden_dim)  # project qpos to embedding
...
def build_detr_vae(args):
    ...
    model = DETRVAE(backbones, transformer, encoder, args)
